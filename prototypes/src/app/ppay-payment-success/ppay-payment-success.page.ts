...
@Component({
  selector: 'app-ppay-payment-success',
  templateUrl: './ppay-payment-success.page.html',
  styleUrls: ['./ppay-payment-success.page.scss'],
})
export class PpayPaymentSuccessPage implements OnInit {
  data: any;
  public fg: FormGroup;
  discount: number = 0;
  // fee: number = 15;
